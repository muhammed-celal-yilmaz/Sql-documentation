...
/****** Object:  Database [UdemyDemo]    Script Date: 3.11.2021 13:24:16 ******/
CREATE DATABASE [UdemyDemo]
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'UdemyDemo', FILENAME = N'C:\Users\celal yılmaz\UdemyDemo.mdf' , SIZE = 8192KB , MAXSIZE = UNLIMITED, FILEGROWTH = 65536KB )
 LOG ON 
( NAME = N'UdemyDemo_log', FILENAME = N'C:\Users\celal yılmaz\UdemyDemo_log.ldf' , SIZE = 8192KB , MAXSIZE = 2048GB , FILEGROWTH = 65536KB )
GO
...
ALTER DATABASE [UdemyDemo] SET RECOVERY SIMPLE 
GO
...
ALTER DATABASE [UdemyDemo] SET TARGET_RECOVERY_TIME = 60 SECONDS 
GO

ALTER DATABASE [UdemyDemo] SET DELAYED_DURABILITY = DISABLED 
GO

ALTER DATABASE [UdemyDemo] SET QUERY_STORE = OFF
GO
